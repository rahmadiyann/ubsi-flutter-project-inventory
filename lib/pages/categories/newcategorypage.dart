...
class _NewCategoryPageState extends State<NewCategoryPage>
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await createCategory(_nameController.text);

        if (!mounted) return;
        setState(() => _isLoading = false);

        _showSnackBar(context,
            "Category '${_nameController.text}' created successfully!", true);
        ...
        _showSnackBar(context, "Failed to create category: $e", false);
      }
    }
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Lottie.asset(
                    'assets/animations/category_animation.json',
                    height: 200,
